      ...
      <div className="antialiased bg-black w-full min-h-screen text-slate-300 relative py-4">
        <div className="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
          <div id="menu" className="bg-white/10 col-span-3 rounded-lg p-4 ">
            <h1 className="font-mono font-bold text-lg lg:text-3xl bg-gradient-to-br from-white via-white/50 to-transparent bg-clip-text text-transparent">
              Hyper Panel<span className="text-indigo-400"> .</span>
            </h1>
            <p className="font-poppins text-slate-400 text-sm mb-2">
              Welcome back,
            </p>
            <a
              href="#"
            ...
            >
              ...
              <div>
                ...
                <span className="text-xs text-slate-400">THC Admin</span>
              </div>
            </a>
            ...
            <div id="menu" className="flex flex-col space-y-2 my-5">
              <a
                href="#"
                className="dashboard hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                onClick={() => setActive(0)}
              >
              ...
              <a
                href="#"
                className="blogmenu hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                onClick={() => setActive(1)}
              >
                <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                  <div>
              ...
              <a
                href="#"
                className="usermenu hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                onClick={() => setActive(2)}
              >
                <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                  <div>
          ...
          <div
            ...
            className={`${
              active == 0 ? "" : "hidden"
            } bg-white/10 col-span-9 rounded-lg p-6`}
          >
            <div id="24h">
          ...
          >
            <div id="last-users">
              <h1 className="font-bold py-4 uppercase">All Users</h1>
              <div className="overflow-x-scroll">
                <table className="w-full whitespace-nowrap">
                  ...
                  <tr className="border-b border-gray-700">
                    ...
                    <td className="py-3 px-2">dhruvdeora31@gmail.com</td>
